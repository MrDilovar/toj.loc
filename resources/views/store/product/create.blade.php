...
@section('content')
    <div class="container product-create">
        ...
        <div class="row">
            <div class="col-lg-6">
                <form class="formsValidate" action="{{ route('store.product.store') }}" method="post"
                                    ...
                                    <div class="pcat-menu" data-menu-id="{{ $category_item->id }}" style="display: none">
                                        ...
                                        @foreach($category_item->children as $children)
                                            @if($children->children->isEmpty())
                                                <div class="pc-category-item">
                                                    <a href="{{ route('store.product.create', ['category_id' => $children->id]) }}">{{ $children->name }}</a>
                                                </div>
                                            @else
                    ...
                    @if(!is_null($category))
                        ...
                        <div class="form-group">
                            ...
                            <div id="dzImage" class="ml-2" data-img-limit="4">
